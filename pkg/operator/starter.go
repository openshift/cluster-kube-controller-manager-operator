...
func RunOperator(ctx context.Context, cc *controllercmd.ControllerContext) error {
	...
	staticResourceController := staticresourcecontroller.NewStaticResourceController(
		...
		[]string{
			...
			"assets/kube-controller-manager/networkpolicy-installer-allow.yaml",
			"assets/kube-controller-manager/networkpolicy-allow.yaml",
			"assets/kube-controller-manager/networkpolicy-default-deny-all.yaml",
		},
