...
// sources:
// bindata/v3.11.0/kube-controller-manager/clusterrolebinding.yaml
// bindata/v3.11.0/kube-controller-manager/cm.yaml
// bindata/v3.11.0/kube-controller-manager/defaultconfig.yaml
// bindata/v3.11.0/kube-controller-manager/ds.yaml
...
var _v3110KubeControllerManagerClusterrolebindingYaml = []byte(`apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
  name: openshift-kube-controller-manager-cluster-admin
roleRef:
  kind: ClusterRole
  name: cluster-admin
subjects:
...
func v3110KubeControllerManagerClusterrolebindingYamlBytes() ([]byte, error) {
	return _v3110KubeControllerManagerClusterrolebindingYaml, nil
}

func v3110KubeControllerManagerClusterrolebindingYaml() (*asset, error) {
	bytes, err := v3110KubeControllerManagerClusterrolebindingYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/kube-controller-manager/clusterrolebinding.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _v3110KubeControllerManagerDsYaml = []byte(`apiVersion: apps/v1
kind: DaemonSet
metadata:
  namespace: openshift-kube-controller-manager
...
func v3110KubeControllerManagerDsYamlBytes() ([]byte, error) {
	return _v3110KubeControllerManagerDsYaml, nil
}

func v3110KubeControllerManagerDsYaml() (*asset, error) {
	bytes, err := v3110KubeControllerManagerDsYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/kube-controller-manager/ds.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"v3.11.0/kube-controller-manager/clusterrolebinding.yaml":      v3110KubeControllerManagerClusterrolebindingYaml,
	...
	"v3.11.0/kube-controller-manager/ds.yaml":                      v3110KubeControllerManagerDsYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v3.11.0": {nil, map[string]*bintree{
		"kube-controller-manager": {nil, map[string]*bintree{
			"clusterrolebinding.yaml":      {v3110KubeControllerManagerClusterrolebindingYaml, map[string]*bintree{}},
			...
			"ds.yaml":                      {v3110KubeControllerManagerDsYaml, map[string]*bintree{}},
