...
// sources:
// bindata/v3.11.0/kube-controller-manager/auth-delegator-rolebinding.yaml
...
var _v3110KubeControllerManagerAuthDelegatorRolebindingYaml = []byte(`apiVersion: rbac.authorization.k8s.io/v1
kind: RoleBinding
metadata:
  namespace: kube-system
  name: system:openshift:auth-delegator-kube-controller-manager
roleRef:
...
func v3110KubeControllerManagerAuthDelegatorRolebindingYamlBytes() ([]byte, error) {
	return _v3110KubeControllerManagerAuthDelegatorRolebindingYaml, nil
}

func v3110KubeControllerManagerAuthDelegatorRolebindingYaml() (*asset, error) {
	bytes, err := v3110KubeControllerManagerAuthDelegatorRolebindingYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/kube-controller-manager/auth-delegator-rolebinding.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"v3.11.0/kube-controller-manager/auth-delegator-rolebinding.yaml":  v3110KubeControllerManagerAuthDelegatorRolebindingYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v3.11.0": {nil, map[string]*bintree{
		"kube-controller-manager": {nil, map[string]*bintree{
			"auth-delegator-rolebinding.yaml":  {v3110KubeControllerManagerAuthDelegatorRolebindingYaml, map[string]*bintree{}},
