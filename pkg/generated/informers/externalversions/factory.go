...
import (
	...
	kubecontrollermanager "github.com/openshift/cluster-kube-controller-manager-operator/pkg/generated/informers/externalversions/kubecontrollermanager"
...
func (f *sharedInformerFactory) Kubecontrollermanager() kubecontrollermanager.Interface {
	return kubecontrollermanager.New(f, f.namespace, f.tweakListOptions)
}
