...
readonly OS_GO_PACKAGE=github.com/openshift/cluster-kube-controller-manager-operator
...
readonly OS_CROSS_COMPILE_TARGETS=(
  cmd/cluster-kube-controller-manager-operator
)
...
function os::build::images() {
  ...
  os::build::image "${tag_prefix}-cluster-kube-controller-manager-operator" .
}
