...
%global package_name origin-cluster-kube-controller-manager-operator
%global product_name OpenShift Cluster kube-controller-manager Operator
%global import_path github.com/openshift/cluster-kube-controller-manager-operator
...
for bin in cluster-kube-controller-manager-operator
do
  echo "+++ INSTALLING ${bin}"
...
%doc README.md
%license LICENSE
%{_bindir}/cluster-kube-controller-manager-operator
