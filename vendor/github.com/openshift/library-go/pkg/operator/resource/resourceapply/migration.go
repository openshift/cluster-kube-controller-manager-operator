...
func ApplyStorageVersionMigration(ctx context.Context, client migrationclientv1alpha1.Interface, recorder events.Recorder, required *migrationv1alpha1.StorageVersionMigration, deleteConditionals ...ConditionalFunction) (*migrationv1alpha1.StorageVersionMigration, bool, error) {
	shouldDelete := false
	...
	if shouldDelete {
		err := clientInterface.Delete(ctx, existing.Name, metav1.DeleteOptions{})
		if err != nil {
			return nil, false, err
		}
