...
// WithDisabledHTTP2 indicates that http2 should not be enabled to mitigate rapid reset http2 issue
func (b *ControllerBuilder) WithDisabledHTTP2() *ControllerBuilder {
	b.disableHTTP2 = true
	return b
}
...
func (b *ControllerBuilder) Run(ctx context.Context, config *unstructured.Unstructured) error {
	...
	if b.servingInfo != nil {
		serverConfig, err := serving.ToServerConfig(ctx, *b.servingInfo, *b.authenticationConfig, *b.authorizationConfig, kubeConfig, kubeClient, b.leaderElection, b.disableHTTP2)
		if err != nil {
			return err
		}
