...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20250728224441-058ea2bb6c28
	github.com/openshift/client-go => github.com/jacobsee/client-go v0.0.0-20250728234542-8cc02ac48011
	github.com/openshift/library-go => github.com/jacobsee/library-go v0.0.0-20250730000442-e9ff9357275c
)
...
require (
	...
	k8s.io/kube-aggregator v0.34.0-beta.0 // indirect
