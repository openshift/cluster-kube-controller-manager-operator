...
require (
	...
	google.golang.org/protobuf v1.36.8 // indirect; to improve error handling
	k8s.io/api v0.35.1
...
replace github.com/openshift/library-go => github.com/ehearne-redhat/library-go v0.0.0-20260304110309-c56f4c30de58
