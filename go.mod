...
require (
	...
	github.com/openshift/library-go v0.0.0-20220131201636-2a46ecd044b3
...
replace github.com/openshift/library-go => github.com/mfojtik/library-go v0.0.0-20220214155855-2cb341e5b068
