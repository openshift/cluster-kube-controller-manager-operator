...
replace (
	github.com/openshift/api => github.com/jacobsee/openshift-api v0.0.0-20250812004502-117e65890d61
	github.com/openshift/client-go => github.com/jacobsee/client-go v0.0.0-20250812013553-0febb847b800
	github.com/openshift/library-go => github.com/jacobsee/library-go v0.0.0-20250812014306-fe240c6d1932
)
...
require (
	...
	k8s.io/apiextensions-apiserver v0.34.0-rc.1 // indirect
	k8s.io/kms v0.34.0-rc.1 // indirect
	k8s.io/kube-aggregator v0.34.0-rc.1 // indirect
